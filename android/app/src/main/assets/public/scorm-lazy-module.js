...
class AddonModScormDataModel12 {
     ...
     */
    constructor(siteId, scorm, scoId, attempt, userData, mode = _services_scorm__WEBPACK_IMPORTED_MODULE_2__["AddonModScormProvider"].MODENORMAL, offline = false, canSaveTracks = true) {
        this.siteId = siteId;
        this.scorm = scorm;
        this.scoId = scoId;
...
let AddonModScormPlayerPage = class AddonModScormPlayerPage {
    ...
    determineAttemptAndMode(attemptsData, accessInfo) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const result = _services_scorm__WEBPACK_IMPORTED_MODULE_12__["AddonModScorm"].determineAttemptAndMode(this.scorm, this.mode, this.attempt, this.newAttempt, incomplete, accessInfo.cansavetrack);
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const [attemptsData, accessInfo] = yield Promise.all([
                    _services_scorm__WEBPACK_IMPORTED_MODULE_12__["AddonModScorm"].getAttemptCount(this.scorm.id, { cmId: this.cmId }),
    ...
    loadSco(sco) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (!this.dataModel) {
                // Create the model.
                this.dataModel = new _classes_data_model_12__WEBPACK_IMPORTED_MODULE_10__["AddonModScormDataModel12"](this.siteId, this.scorm, sco.id, this.attempt, (_a = this.userData) !== null && _a !== void 0 ? _a : {}, this.mode, this.offline, this.canSaveTracks);
